...
-(void)setBasicPlanDictionary{
    ...
    [dictBasicPlanData setObject:@"0" forKey:@"ExtraPremiumPercentage"];
    [dictBasicPlanData setObject:@"0" forKey:@"ExtraPremiumMil"];
    [dictBasicPlanData setObject:@"0" forKey:@"ExtraPremiumTerm"];
