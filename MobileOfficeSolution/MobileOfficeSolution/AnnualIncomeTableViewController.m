//
//  AnnualIncomeTableViewController.m
...
@interface AnnualIncomeTableViewController ()

@end

@implementation AnnualIncomeTableViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        NSDictionary *dict = [modelPopOver getAnnualIncome];
        _items = [dict objectForKey:@"AnnDesc"];
...
{
    NSString *theSourceIncome = [_items objectAtIndex:indexPath.row];
    SelectedString = theSourceIncome;
    [_delegate selectedAnnualIncome:theSourceIncome];
