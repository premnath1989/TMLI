...
@implementation AgentWS_SyncDataVersion
- (id)init
{
    if((self = [super init])) {
        Version = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.Version != 0) {
        xmlAddChild(node, [self.Version xmlNodeForDoc:node->doc elementName:@"Version" elementNSPrefix:@"AgentWS"]);
    }
    if(self.strStatus != 0) {
        xmlAddChild(node, [self.strStatus xmlNodeForDoc:node->doc elementName:@"strStatus" elementNSPrefix:@"AgentWS"]);
    }
...
{
    AgentWS_SyncDataVersion *newObject = [[AgentWS_SyncDataVersion new] autorelease];
...
- (void)dealloc
{
    if(SyncDataVersionResult != nil) [SyncDataVersionResult release];
    if(strStatus != nil) [strStatus release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.SyncDataVersionResult != 0) {
        xmlAddChild(node, [self.SyncDataVersionResult xmlNodeForDoc:node->doc elementName:@"SyncDataVersionResult" elementNSPrefix:@"AgentWS"]);
    }
    if(self.strStatus != 0) {
        xmlAddChild(node, [self.strStatus xmlNodeForDoc:node->doc elementName:@"strStatus" elementNSPrefix:@"AgentWS"]);
    }
...
/* elements */
@synthesize SyncDataVersionResult;
@synthesize strStatus;
/* attributes */
- (NSDictionary *)attributes
{
...
{
    AgentWS_SyncDataVersionResponse *newObject = [[AgentWS_SyncDataVersionResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
    ...
    for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
        if(cur->type == XML_ELEMENT_NODE) {
            ...
            if(xmlStrEqual(cur->name, (const xmlChar *) "SyncDataVersionResult")) {
                ...
                self.SyncDataVersionResult = newChild;
            }
            if(xmlStrEqual(cur->name, (const xmlChar *) "strStatus")) {
...
{
    return [self performSynchronousOperation:[[(AgentWSSoapBinding_SyncDataVersion*)[AgentWSSoapBinding_SyncDataVersion alloc] initWithBinding:self delegate:self
                                                                                                                                    parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoapBinding_SyncDataVersion*)[AgentWSSoapBinding_SyncDataVersion alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                               parameters:aParameters
                                          ] autorelease]];
}
- (AgentWSSoapBindingResponse *)GetAllBackgroundImageUsingParameters:(AgentWS_GetAllBackgroundImage *)aParameters delegate:(id<AgentWSSoapBindingResponseDelegate>)responseDelegate

{
    return [self performSynchronousOperation:[[(AgentWSSoapBinding_GetAllBackgroundImage*)[AgentWSSoapBinding_GetAllBackgroundImage alloc] initWithBinding:self delegate:self
                                                                                                                                                parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoapBinding_GetAllBackgroundImage*)[AgentWSSoapBinding_GetAllBackgroundImage alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                                           parameters:aParameters
                                          ] autorelease]];
}
...
{
    return [self performSynchronousOperation:[[(AgentWSSoapBinding_GetAllProductInfo*)[AgentWSSoapBinding_GetAllProductInfo alloc] initWithBinding:self delegate:self
                                                                                                                                      parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoapBinding_GetAllProductInfo*)[AgentWSSoapBinding_GetAllProductInfo alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                                 parameters:aParameters
                                          ] autorelease]];
}
...
@end
@implementation AgentWSSoapBinding_SyncDataVersion
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoapBinding *)aBinding delegate:(id<AgentWSSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) [bodyElements setObject:parameters forKey:@"SyncDataVersion"];
    
    NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
    
    [binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://tempuri.org/SyncDataVersion" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    if (responseData != nil && delegate != nil)
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "SyncDataVersionResponse")) {
                                    AgentWS_SyncDataVersionResponse *bodyObject = [AgentWS_SyncDataVersionResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) &&
...
{
    return [self performSynchronousOperation:[[(AgentWSSoap12Binding_SyncDataVersion*)[AgentWSSoap12Binding_SyncDataVersion alloc] initWithBinding:self delegate:self
                                                                                                                                        parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoap12Binding_SyncDataVersion*)[AgentWSSoap12Binding_SyncDataVersion alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                                   parameters:aParameters
                                          ] autorelease]];
}
- (AgentWSSoap12BindingResponse *)GetAllBackgroundImageUsingParameters:(AgentWS_GetAllBackgroundImage *)aParameters
{
    return [self performSynchronousOperation:[[(AgentWSSoap12Binding_GetAllBackgroundImage*)[AgentWSSoap12Binding_GetAllBackgroundImage alloc] initWithBinding:self delegate:self
                                                                                                                                                    parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoap12Binding_GetAllBackgroundImage*)[AgentWSSoap12Binding_GetAllBackgroundImage alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                                               parameters:aParameters
                                          ] autorelease]];
}
...
{
    return [self performSynchronousOperation:[[(AgentWSSoap12Binding_GetAllProductInfo*)[AgentWSSoap12Binding_GetAllProductInfo alloc] initWithBinding:self delegate:self
                                                                                                                                          parameters:aParameters
                                               ] autorelease]];
}
...
{
    [self performAsynchronousOperation: [[(AgentWSSoap12Binding_GetAllProductInfo*)[AgentWSSoap12Binding_GetAllProductInfo alloc] initWithBinding:self delegate:responseDelegate
                                                                                                                                     parameters:aParameters
                                          ] autorelease]];
}
...
@end
@implementation AgentWSSoap12Binding_SyncDataVersion
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoap12Binding *)aBinding delegate:(id<AgentWSSoap12BindingResponseDelegate>)responseDelegate
           parameters:(AgentWS_SyncDataVersion *)aParameters
{
...
@implementation AgentWS_GetAllBackgroundImage
- (id)init
{
    if((self = [super init])) {
...
{
    AgentWS_GetAllBackgroundImage *newObject = [[AgentWS_GetAllBackgroundImage new] autorelease];
...
@implementation AgentWS_GetAllBackgroundImageResult
@synthesize xmlDetails;
- (id)init
{
    if((self = [super init])) {
...
+ (AgentWS_GetAllBackgroundImageResult *)deserializeNode:(xmlNodePtr)cur
{
    ...
    AgentWS_GetAllBackgroundImageResult *newObject = [[AgentWS_GetAllBackgroundImageResult new] autorelease];
    newObject.xmlDetails = str;
    [newObject deserializeAttributesFromNode:cur];
    [newObject deserializeElementsFromNode:cur];
...
@implementation AgentWS_GetAllBackgroundImageResponse
- (id)init
{
    if((self = [super init])) {
        GetAllBackgroundImageResult = 0;
    }
...
- (void)dealloc
{
    if(GetAllBackgroundImageResult != nil) [GetAllBackgroundImageResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.GetAllBackgroundImageResult != 0) {
        xmlAddChild(node, [self.GetAllBackgroundImageResult xmlNodeForDoc:node->doc elementName:@"GetAllBackgroundImageResult" elementNSPrefix:@"AgentWS"]);
    }
    if(self.strStatus != 0) {
        xmlAddChild(node, [self.strStatus xmlNodeForDoc:node->doc elementName:@"strStatus" elementNSPrefix:@"AgentWS"]);
    }
...
/* elements */
@synthesize GetAllBackgroundImageResult;
/* attributes */
- (NSDictionary *)attributes
{
    NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
    AgentWS_GetAllBackgroundImageResponse *newObject = [[AgentWS_GetAllBackgroundImageResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
    ...
    for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
        if(cur->type == XML_ELEMENT_NODE) {
            ...
            if(xmlStrEqual(cur->name, (const xmlChar *) "GetAllBackgroundImageResult")) {
                
                Class elementClass = nil;
                xmlChar *instanceType = xmlGetNsProp(cur, (const xmlChar *) "type", (const xmlChar *) "http://www.w3.org/2001/XMLSchema-instance");
                if(instanceType == NULL) {
                    elementClass = [AgentWS_GetAllBackgroundImageResult class];
                } else {
                    NSString *elementTypeString = [NSString stringWithCString:(char*)instanceType encoding:NSUTF8StringEncoding];
                ...
                self.GetAllBackgroundImageResult = newChild;
            }
        }
    }
}
...
@implementation AgentWSSoapBinding_GetAllBackgroundImage
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoapBinding *)aBinding delegate:(id<AgentWSSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) [bodyElements setObject:parameters forKey:@"GetAllBackgroundImage"];
    
    NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
    
    [binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://tempuri.org/GetAllBackgroundImage" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    if (responseData != nil && delegate != nil)
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "GetAllBackgroundImageResponse")) {
                                    AgentWS_GetAllBackgroundImageResponse *bodyObject = [AgentWS_GetAllBackgroundImageResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) &&
...
@implementation AgentWSSoap12Binding_GetAllBackgroundImage
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoap12Binding *)aBinding delegate:(id<AgentWSSoap12BindingResponseDelegate>)responseDelegate
           parameters:(AgentWS_GetAllBackgroundImage *)aParameters
{
...
// ######################################################################################################
// this block is for get all product information

//This is block to be used for Hierarchy
// #######################################################################################################################

@implementation AgentWSSoapBinding_GetAllProductInfo
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoapBinding *)aBinding delegate:(id<AgentWSSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) [bodyElements setObject:parameters forKey:@"GetAllProductInfo"];
    
    NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
    
    [binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://tempuri.org/GetAllProductInfo" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    if (responseData != nil && delegate != nil)
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "GetAllProductInfoResponse")) {
                                    AgentWS_GetAllProductInfoResponse *bodyObject = [AgentWS_GetAllProductInfoResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) &&
...
@implementation AgentWSSoap12Binding_GetAllProductInfo
@synthesize parameters;
- (id)initWithBinding:(AgentWSSoap12Binding *)aBinding delegate:(id<AgentWSSoap12BindingResponseDelegate>)responseDelegate
           parameters:(AgentWS_GetAllProductInfo *)aParameters
{
...
@implementation AgentWS_GetAllProductInfo
- (id)init
{
    if((self = [super init])) {
    }
...
{
    AgentWS_GetAllProductInfo *newObject = [[AgentWS_GetAllProductInfo new] autorelease];
...
@end
@implementation AgentWS_GetAllProductInfoResult
@synthesize xmlDetails;
- (id)init
{
    if((self = [super init])) {
...
+ (AgentWS_GetAllProductInfoResult *)deserializeNode:(xmlNodePtr)cur
{
    ...
    AgentWS_GetAllProductInfoResult *newObject = [[AgentWS_GetAllProductInfoResult new] autorelease];
    newObject.xmlDetails = str;
    [newObject deserializeAttributesFromNode:cur];
    [newObject deserializeElementsFromNode:cur];
...
@end
@implementation AgentWS_GetAllProductInfoResponse
- (id)init
{
    if((self = [super init])) {
        GetAllProductInfoResult = 0;
    }
...
- (void)dealloc
{
    if(GetAllProductInfoResult != nil) [GetAllProductInfoResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.GetAllProductInfoResult != 0) {
        xmlAddChild(node, [self.GetAllProductInfoResult xmlNodeForDoc:node->doc elementName:@"GetAllProductInfoResult" elementNSPrefix:@"AgentWS"]);
    }
}
/* elements */
@synthesize GetAllProductInfoResult;
/* attributes */
- (NSDictionary *)attributes
{
    NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
    AgentWS_GetAllProductInfoResponse *newObject = [[AgentWS_GetAllProductInfoResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
    ...
    for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
        if(cur->type == XML_ELEMENT_NODE) {
            ...
            if(xmlStrEqual(cur->name, (const xmlChar *) "GetAllProductInfoResult")) {
                
                Class elementClass = nil;
                xmlChar *instanceType = xmlGetNsProp(cur, (const xmlChar *) "type", (const xmlChar *) "http://www.w3.org/2001/XMLSchema-instance");
                if(instanceType == NULL) {
                    elementClass = [AgentWS_GetAllProductInfoResult class];
                } else {
                    NSString *elementTypeString = [NSString stringWithCString:(char*)instanceType encoding:NSUTF8StringEncoding];
                ...
                self.GetAllProductInfoResult = newChild;
            }
        }
    }
}
