...
#import "CFFTabBar.h"
#import "CFFTabBarButton.h"
#import <QuartzCore/QuartzCore.h>

#define DEFAULT_ITEM_HEIGHT 80.0


@implementation CFFTabBar
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CFFTabBarButton *cell = [tableView dequeueReusableCellWithIdentifier:vtbci];
    if (cell == nil)
    {
        cell = [[CFFTabBarButton alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:vtbci];
    }
