 ...
 *   <tr> <td> "MirrorTablet" </td>     <td> false </td>     <td> SPBOOL </td> <td> Mirror tablet, see @ref SP_DRAW_MIRROR_TABLET for details </td> </tr>
 *   <tr> <td> "NoStrokeEcho" </td>     <td> false </td>     <td> SPBOOL </td> <td> set stroke echo, see @ref SP_VIRTUAL_BUTTON_MODE for details </td> </tr>
 *   <tr> <td> "ButtonClickMode" </td>  <td> true </td>      <td> SPBOOL </td> <td> set button click mode, see @ref SP_VIRTUAL_BUTTON_CLICK for details </td> </tr>
 * </table>
 * @endhtmlonly
 */
 ...
 * @see SPAcquireRegisterRect
 */
typedef int (SPCALLBACK *pSPACQUIREDOCRECTLISTENER_T)(pSPACQUIRE_T pSpAcquire, SPUINT32 uDocId, SPUINT32 uRectId);
 ...
 *
 * @param pSpAcquire [i]
 *      pointer to the SPAcquire object that generated the event.
 * @param iX [i]
 ...
 */
typedef int (SPCALLBACK * pSPACQUIRELINETO_T)(pSPACQUIRE_T pSpAcquire, SPINT32 iX, SPINT32 iY, SPINT32 iPress, SPINT32 iTime);
 ...
 * <br> Use @ref SPAcquireSetBoolProperty instead 
 *
 * @param pSpAcquire [i]
 *      pointer to an SPAcquire object.
 ...
 * @see SPAcquireSetBoolProperty, SPAcquireGetTablet, SPAcquireGetHwnd, SPTabletAcquire, SPTabletAcquireDone
 */
 ...
 *  
 * @note  Use @ref SPAcquireSetBoolProperty instead 
 *
 * @param pSpAcquire [i]
 *      pointer to an SPAcquire object.
 * @param piDrawMode [o]
 ...
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 */
SPEXTERN SPINT32 SPLINK SPAcquireSetBoolProperty(pSPACQUIRE_T pSPAcquire, const SPCHAR *pszName, SPBOOL bValue);
 ...
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 */
SPEXTERN SPINT32 SPLINK SPAcquireGetBoolProperty(pSPACQUIRE_T pSPAcquire, const SPCHAR *pszName, SPBOOL *pbValue);
 ...
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 */
SPEXTERN SPINT32 SPLINK SPAcquireSetVectorListener(pSPACQUIRE_T pSpAcquire, pSPACQUIRELINETO_T pNotifyVector);
 ...
 * @par Operating Systems:
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 * @see SPTabletCreateByEnum, SPAcquireCreateTablet, SPAcquireCreateTabletEx, SPAcquireConnectByEnum
 */
SPEXTERN SPINT32 SPLINK SPAcquireCreateTabletByEnum(pSPACQUIRE_T pSPAcquire, pSPPROPERTYMAP_T spDescriptor);
 ...
 * @param pSPAcquire [i]
 *      pointer to an SPAcquire object.
 * @param spDescriptor [i] the descriptor of the enumerated tablet
 * 
 * @return @ref SP_NOERR on success, else error code:
 *   - @ref SP_PARAMERR      invalid parameter, e. g.pszAlias is NULL or empty
 *   - @ref SP_MEMERR        out of memory
 ...
 * @par Operating Systems:
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 * @see SPTabletCreateByEnum, SPAcquireConnect, SPAcquireConnectEx, SPAcquireCreateTabletByEnum
 */
SPEXTERN SPINT32 SPLINK SPAcquireConnectByEnum(pSPACQUIRE_T pSPAcquire, pSPPROPERTYMAP_T spDescriptor);
 ...
 * @par Operating Systems:
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 * @see SPAcquireAcquire, SPAcquireSetButtonListener, SPTabletHasProximity, SPTabletSetBoolProperty SP_VIRTUAL_BUTTON_CLICK
 */
 ...
 * @par Operating Systems:
 *      Windows (Win32), Linux (i386), Linux (x86_64), Linux (ARM)
 * @see SPAcquireAcquire, SPTabletHasProximity, SPTabletSetBoolProperty, SP_VIRTUAL_BUTTON_CLICK
 ...
 * @see SPFreeString
 */
SPEXTERN SPINT32 SPLINK SPAcquireGetBackgroundText(pSPACQUIRE_T pSPAcquire, SPINT32 iSource, SPCHAR **ppszText);
 ...
 *    - Dynamically assign the document content (see @ref SPAcquireSetDocumentContent)
 *    - Register a Document event listener (see @ref SPAcquireSetDocumentListener) to process virtual 
 *      button events that are assigned to a document.
 *    - Dynamically create virtual buttons in a document, see @ref SPAcquireRegisterDocumentRect 
 *    .
 * 
 * @param pSpAcquire [i]
 *      pointer to an SPAcquire object.
 ...
 *     .
 *  
 * @see SPAcquireSetDocumentContent, SPAcquireRegisterDocumentRect 
 * @see sec_DocumentDescriptionDTD 
 */
SPEXTERN SPINT32 SPLINK SPAcquireSetDocumentListener(pSPACQUIRE_T pSpAcquire, pSPACQUIREDOCRECTLISTENER_T pListener);
 ...
 *     .
 *  
 * @see SPAcquireSetDocumentContent, SPAcquireSetDocumentListener
 * @see sec_DocumentDescriptionDTD
 */
SPEXTERN SPINT32 SPLINK SPAcquireRegisterDocumentRect(pSPACQUIRE_T pSpAcquire, SPUINT32 aId, const SPCHAR *pszVirtualButtonDescription);
