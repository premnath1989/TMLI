...
function setPage(){
    ...
    $('.TotalBasicPremium').html('<b>Total Basic Account Premium' + formatCurrency(parseFloat(gdata.SI[0].ATPrem) + parseFloat(gdata.SI[0].ATU) ) + '</b>');
	...
	if(parseInt(gdata.SI[0].ATU) !=  '0'){
		$('#Page1Basic > tbody').append('<tr>' +
			...
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black; ">Regular Top Up</td>' +
	...
	$.each(gdata.SI[0].UL_Temp_trad_Details.data, function(index, row) {			
		...
		if(row.RiderCode == 'LCWP' || row.RiderCode == 'PR'){
			...
			*/
			if(row.PTypeCode == 'LA')
			{
				tempOccpClass =	'Class ' + (gdata.SI[0].UL_Temp_trad_LA.data[1].OccpClass == '5' ? 'D' : gdata.SI[0].UL_Temp_trad_LA.data[1].OccpClass) ;
				...
				if(gdata.SI[0].UL_Temp_trad_LA.data.length > 2){
					tempOccpClass =	'Class ' + (gdata.SI[0].UL_Temp_trad_LA.data[2].OccpClass == '5' ? 'D' : gdata.SI[0].UL_Temp_trad_LA.data[2].OccpClass) ;
			...
			if(row.RiderCode == 'CIWP' || row.RiderCode == 'ACIR' || row.RiderCode == 'MDSR1' || row.RiderCode == 'MDSR2' || row.RiderCode == 'CIRD' || row.RiderCode == 'DCA' ||
			   row.RiderCode == 'DHI' || row.RiderCode == 'HMM' || row.RiderCode == 'MR' || row.RiderCode == 'PA' || row.RiderCode == 'TPDMLA' || row.RiderCode == 'TPDYLA' ||
			   row.RiderCode == 'DHI' || row.RiderCode == 'WI' || row.RiderCode == 'MG_IV' ){
...
function Page16()
{
	 ...
	 if(gdata.SI[0].BumpMode == 'A'){
		...
		$('.Page16PaymentModeLabel').html('<b>Annual Target Premium<br/>Payable(RM)</b>' );
		$('.Page16LoadingLabel').html('<b>Annual Loading<br/>Amount (RM)</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'S'){
		
		$('.Page16PaymentModeLabel').html('<b>Semi-Annual Target Premium<br/>Payable(RM)</b>');
		$('.Page16LoadingLabel').html('<b>Semi-Annual Loading<br/>Amount (RM)</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'Q'){
		
		$('.Page16PaymentModeLabel').html('<b>Quarterly Target Premium<br/>Payable(RM)</b>');
		$('.Page16LoadingLabel').html('<b>Quarterly Loading<br/>Amount (RM)</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'M'){
		
		$('.Page16PaymentModeLabel').html('<b>Monthly Target Premium<br/>Payable(RM)</b>');
		$('.Page16LoadingLabel').html('<b>Monthly Loading<br/>Amount (RM)</b>' );
	}
	...
	if(gdata.SI[0].UL_Temp_trad_Details.data.length > 0){
		...
		$('#table-data16 > tfoot').append('<tr><td colspan="10" style="text-align:right;padding: 2px 2px 2px 2px;border: 1px solid black;"><b>Total Riders Premium ' + formatCurrency(totalRiderPremium) + '</b></br></td></tr>' ); 
	}
	      
	      
	if(gdata.SI[0].BumpMode == 'A'){
		$('.TotalOverAllPremium16').html('<b>Total Premium Payable(Annual) ' + formatCurrency(parseFloat(gdata.SI[0].ATPrem) + parseFloat(totalRiderPremium)) + '</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'S'){
		$('.TotalOverAllPremium16').html('<b>Total Premium Payable(Semi-Annual) ' + formatCurrency(parseFloat(gdata.SI[0].ATPrem) + parseFloat(totalRiderPremium)) + '</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'Q'){
		$('.TotalOverAllPremium16').html('<b>Total Premium Payable(Quarterly) ' + formatCurrency(parseFloat(gdata.SI[0].ATPrem) + parseFloat(totalRiderPremium)) + '</b>' );
	}
	else if(gdata.SI[0].BumpMode == 'M'){
		$('.TotalOverAllPremium16').html('<b>Total Premium Payable(Monthly) ' + formatCurrency(parseFloat(gdata.SI[0].ATPrem) + parseFloat(totalRiderPremium)) + '</b>' );
	}
...
/*
function SetFundAllocationCommencementRow(targetDate_str, vu2025, vu2028, vu2030, vu2035, vuVenture, vuGrowth, vuBlueChip, vuDana, vuManaged, vuRet, vuVentureIncome, vuCash) {
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">Commencement Date to ' + targetDate_str + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2025) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2028) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2030) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2035) + '</td>'+
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuVenture) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuGrowth)+ '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuBlueChip) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuDana) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuManaged) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuRet) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuVentureIncome) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vuCash) + '</td>' +
			'</tr>');
}

function SetFundAllocationMaturityRow(targetDate_1_str, vu2025, vu2028, vu2030, vu2035, vuVenture, vuGrowth, vuBlueChip, vuDana, vuManaged, vuRet, vuVentureIncome, vuCash) {
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">' + targetDate_1_str + ' to Policy Maturity Date</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2025) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2028) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2030) + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(vu2035) + '</td>'+
...
function Page3_UV()
{
	...
	$('.Page3ShowOnEverLife1').html('<span class="fnPage3_1"></span>&nbsp;&nbsp;&nbsp;Your insurance charge (which is not guaranteed and deducted from the fund value) will increase as you get older. It is possible that the fund value may be insufficient to pay for the high insurance charge and policy fee in later years due to<br/>' +
			'circumstances such as poor fund returns, premium holiday or withdrawals causing your policy to lapse before attaining the age of 100. In such event you may need to top up your premium to ensure continuous coverage.');
	
	if( gdata.SI[0].UL_Page3.data[0].VU2025 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0"){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">Commencement Date to 25/11/2025</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2028 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" ){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">Commencement Date to 25/11/2028</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2030 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" && gdata.SI[0].UL_Page3.data[0].VU2028 == "0" ){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">Commencement Date to 25/11/2030</td>' +
			//'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + formatCurrency(gdata.SI[0].UL_Page3.data[0].VU2030) + '</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2035 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" && gdata.SI[0].UL_Page3.data[0].VU2028 == "0" && gdata.SI[0].UL_Page3.data[0].VU2030 == "0" ){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">Commencement Date to 25/11/2035</td>' +
			//'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
	...
	for(var i = 0; i < gdata.SI[0].UL_Temp_trad_Details.data.length; i++ ){
		if(gdata.SI[0].UL_Temp_trad_Details.data[i].RiderCode == 'CCR'){
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) >15){
				...
				tempAge2 = parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 5 + ' To ' + (parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 14);
				tempAge3 = parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 15 + ' To ' + (parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod));
				
				$('#Page5CCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To 5<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td style = "text-align: center;">Rider Year 6 To 15<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge2  +'</td>' +
				...
				$('#Page5CCR > tbody').append('<tr><td style = " width: 34%">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
			}
			else if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) >5){
				tempAge1 = gdata.SI[0].UL_Temp_trad_LA.data[0].Age + ' To ' + (parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 4);
				tempAge2 = parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 5 + ' To ' + (parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod));
				
				$('#Page5CCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To 5<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td style = "text-align: center;">Rider Year 6 To ' + gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge2  + '</td><td></td></tr>');
			...
			else
			{
				...
				$('#Page5CCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To ' + gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td></td><td></td></tr>');
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) >15){
				...
				$('#Page5TCCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To 5<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td style = "text-align: center;">Rider Year 6 To 15<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge2  +'</td>' +
								  '<td style = "text-align: center;">Rider Year 16 To ' + gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge3  + '</td></tr>');
				
				$('#Page5TCCR > tbody').append('<tr><td style = "width: 34%">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
				...
				$('#Page5TCCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To 5<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td style = "text-align: center;">Rider Year 6 To ' + gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge2  + '</td><td></td></tr>');
			...
			else
			{
				...
				$('#Page5TCCR > thead').append('<tr><td style = "text-align: center;">Rider Year 1 To ' + gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td><td></td><td></td></tr>');
			...
			$('#Page5TCCR > tfoot').append('<tr><td><b>Total Premium</b></td><td> ' + formatCurrency(tempTotal1) + '</td><td>' + formatCurrency(tempTotal2) + '</td><td>'+ formatCurrency(tempTotal3) +  '</td></tr>');
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) + parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) > 29){
				...
				$('#Page5JCCR > thead').append('<tr><td style = "text-align: center;">Rider Year ' + tempPol1 + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge1  + '</td>' +
								...
								'<td style = "text-align: center;">Rider Year ' + tempPol3 + '<br/><sup><span class="fnPage5_Age"></span></sup>LA Age(EOY)' + tempAge3  + '</td></tr>');
				
				$('#Page5JCCR > tbody').append('<tr><td style = " width: 34%">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
			...
			else if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) + parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) > 15){
				tempPol1 = 1 + ' To ' + (16 - parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age));
				tempAge1 = (parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) + 1) + ' To ' + 16;
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) >15){
				...
				$('#Page5LDYR > tbody').append('<tr><td style = " width: 34% ">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
			}
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod) >15){
				...
				$('#Page5MSR > tbody').append('<tr><td style = " width: 34% ">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod ) + parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) > 80){
				...
				$('#Page5MDSR1 > tbody').append('<tr><td style = " width: 34% ">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
			...
			if(parseInt(gdata.SI[0].UL_Temp_trad_Details.data[i].CovPeriod ) + parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) > 80){
				...
				$('#Page5MDSR2 > tbody').append('<tr><td style = " width: 34%">' + gdata.SI[0].UL_Temp_trad_Details.data[i].RiderDesc  + '</td>' +
								'<td style = "text-align: center; width: 22% ">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].AnnualTarget)  + '</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium2) +'</td>' +
								'<td style = "text-align: center; width: 22%">' + formatCurrency(gdata.SI[0].UL_Temp_trad_Details.data[i].Premium3) + '</td></tr>');
	...
	if(gdata.SI[0].UL_Temp_Summary.data.length > 0){
		...
		for(var i = 0; i < ArrayPrem.length; i++){
			...
			if(i == ArrayPrem.length - 1){
				...
				var lastYear;
				var AgeAtLastYear;
				if(parseInt(ArrayPolYearStart[next]) != 100){
					lastYear = 100 - parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) ;
					AgeAtLastYear = 100;
					text1 = ArrayPolYearStart[i] +  ' To '  + lastYear;
					text2 = (ArrayAge[i]) +  ' To ' + AgeAtLastYear;
				}
				else{
					text1 = ArrayPolYearStart[i] +  ' To '  + (parseInt(ArrayPolYearStart[next]) );
					text2 = (ArrayAge[i]) +  ' To ' + (parseInt(ArrayAge[next]));	
				}
				*/
				text1 = ArrayPolYearStart[i] +  ' To '  + (parseInt(ArrayPolYearStart[next]) );
				text2 = (ArrayAge[i]) +  ' To ' + (parseInt(ArrayAge[next]));	
				...
				text1 = ArrayPolYearStart[i] +  ' To '  + (parseInt(ArrayPolYearStart[next]) - 1);
				text2 = (ArrayAge[i]) +  ' To ' + (parseInt(ArrayAge[next]) - 1);
			}
...
function Page6_UV()
{
	...
	if(gdata.SI[0].TopupStart == '-'){
		...
		if(gdata.SI[0].BumpMode == 'A'){
			...
			$('.BUAAmount').html(round2Decimal(parseFloat(gdata.SI[0].TopupAmount) /0.5));	
		}
		else if(gdata.SI[0].BumpMode == 'Q'){
			$('.BUAAmount').html(round2Decimal(parseFloat(gdata.SI[0].TopupAmount) /0.25));	
		}
		else if(gdata.SI[0].BumpMode == 'M'){
			$('.BUAAmount').html(round2Decimal(parseFloat(gdata.SI[0].TopupAmount) /0.0833333));	
		}
	}
...
function Page31_UP()
{
	...
	$.each(gdata.SI[0].UL_Temp_Summary.data, function(index, row) {		
		...
		if(parseInt(index) < 30){
			...
			CurrencyNoCents(row.col16) +  '</td><td>' + CurrencyNoCents(row.col17) + '</td><td>' + CurrencyNoCents(row.col19) +  '</td></tr>');		
		}
...
function Page44_UV(){
	...
	if(tempECAR60Exist == true){
		$('.Page44-ECAR60').html( '<b>Tax Penalty for Early Full Surrender</b><br/>' +
				'<b>In line with the retirement objectives of a Deferred Annuity product, you would be subject to a tax penalty for surrender of this rider before the minimum retirement age in addition to the imposition of surrender charge. To illustrate,' +
				'an 8% tax penalty deducted from your surrender value will result in the following:<br/>' +
				'Assuming that you surrender your EverCash 60 Rider at age 50, the surrender value of EverCash 60 Rider is RM50,000. After a deduction of 8% tax penalty on the surrender value (ie RM50,000 x 8/100 = RM4,000, which will be paid to the tax authority), you will only receive RM46,000 (ie RM50,000 &dash; RM4,000) as your surrender value.</b>')
...
function Page50_UV()
{
	...
	*/
	...
	if(parseFloat(tempBasicPlanAndECARRider) > 0){
		...
		$('.Page50-col4').html(CurrencyNoCents(parseFloat(tempBasicPlanAndECARRider) + parseFloat(tempRTUO) + parseFloat(AnnualisedValue(tempBasicPlanAndOtherRider))));
	}
	else
	{
		label = '-'
	...
	if(gdata.SI[0].PlanCode == 'UV'){
		//total2 = parseFloat(AnnualisedValue(gdata.SI[0].ATPrem) ) * (70 - parseInt(gdata.SI[0].UL_Temp_trad_LA.data[0].Age) - parseInt(gdata.SI[0].ReducedPaidUpYear) ) ;
			...
			$.each(gdata.SI[0].UL_Temp_trad_Details.data, function(index, row) {
				...
				if(parseInt(row.PaymentTerm) >= parseInt(arr[i + 1])  ){
					if(parseInt(arr[i + 1]) <= row.RiderHLoadingTerm || parseInt(row.RiderHLoadingTerm) == '0'){
						...
						tempRider = parseFloat(tempRider)+ parseFloat(AnnualisedValue2(row.TotalPremium)) - parseFloat(AnnualisedValue2(row.RiderLoadingPremium));
					}
	...
	if(parseInt(gdata.SI[0].ReducedPaidUpYear) > 24){
		//$('.Page50-ShowIllus').html('Please note that you have selcted to convert the Basic Plan to a Reduced Paid Up policy after 30th policy aniversary. Therefore, projected fund value for the Reduced Paid Up Policy is not illustrated here.');	
	}
	else{
...
function writeRiderPage3_HLCP()
{
	if ($.trim(gdata.SI[0].Trad_Details.data[0].CashDividend) == 'ACC'){
		...
		$('.paymentDesc').html(gdata.SI[0].SI_Temp_Trad.data[0].CashPaymentD  + '&nbsp;(Cash Dividend Payout)<br/><i>' + gdata.SI[0].SI_Temp_Trad.data[0].MCashPaymentD + '&nbsp;(Dividen Tunai Dibayar)</i>');
	}
		...
		if (row.riders != "" && row.riders != "(null)"){
			...
			for (i=0;i<rider.length;i++){
				...
				if(rider[i] == 'PR_SECOND' || rider[i] == 'LCWP_SECOND'){
					$("#" + row.PageDesc + " .RiderDescPType").html('2nd Life Assured');
				}
				else if(rider[i] == 'PR_PAYOR' || rider[i] == 'LCWP_PAYOR'){
					$("#" + row.PageDesc + " .RiderDescPType").html('Payor');
				}
				else{
					$("#" + row.PageDesc + " .RiderDescPType").html('1st Life Assured');
				}
				...
				$(tblRider).css('display','table-row');
					...
					if (rider[i] == "C"){
						...
						$.each(gdata.SI[0].UL_Temp_trad_Details.data, function(index, rowRider) {	
							if (rowRider.RiderCode == "CCR"){
								$("#" + row.PageDesc + " .CCRRiderTerm").html(rowRider.CovPeriod);	
								$("#" + row.PageDesc + " .CCRRiderSA").html(formatCurrency(rowRider.SumAssured)+"");
								$("#" + row.PageDesc + " .CCRRiderPlan").html('-'+"");
								$("#" + row.PageDesc + " .CCRRiderBenefit").html('-'+"");
								$("#" + row.PageDesc + " .FirstLA").html(gdata.SI[0].UL_Temp_trad_LA.data[0].Name);
								$("#" + row.PageDesc + ' #illness tr').css('display','table-row');
							}
						});
						...
						$.each(gdata.SI[0].UL_Temp_trad_Details.data, function(index, rowRider) {	
							if (rowRider.RiderCode == "MSR"){
								$("#" + row.PageDesc + " .MSRRiderTerm").html(rowRider.CovPeriod);					
								$("#" + row.PageDesc + " .MSRRiderSA").html(formatCurrency(rowRider.SumAssured)+"");
								$("#" + row.PageDesc + " .MSRRiderPlan").html('-');
								$("#" + row.PageDesc + " .MSRRiderBenefit").html('-'+"");
								$("#" + row.PageDesc + " .FirstLA").html(gdata.SI[0].UL_Temp_trad_LA.data[0].Name);
							}
						});
					}
...
function Page7_2_UV()
{
	...
	if(Found1 == true){
		$('#Page8BasicAge').html('aaaMonthly insurance charges will be higher than the monthly allocated premium at Life Assured&apos;s age ' + FoundValue1  + '(last birthday).<br/>');
	} else {
		$('#Page8BasicAge').html('');	
	}
...
function Page9_UV()
{
	...
	if(parseFloat(gdata.SI[0].WithdrawAmount) > 0.00 ){
		...
		$('.Page9Withdrawal').html('<span class="fnPage9_Withdrawal"></span> The projected Total Surrender Value is after the regular withdrawal of RM' + 
		formatCurrency(gdata.SI[0].WithdrawAmount) + ' every ' + gdata.SI[0].WithdrawInterval +
					   ' year starting from policy year ' + gdata.SI[0].WithdrawAgeFrom + ' to policy year ' + gdata.SI[0].WithdrawAgeTo + '. ');
	...
	if(gdata.SI[0].ECARReinvest == 'Yes' ){
		$('.Page9ECARLabel').html('<br/>(Inclusive of Reinvestment of GYI/ GMI)');		
	}
	else
	{
		$('.Page9ECARLabel').html('');		
...
function Page9_UP()
{
	...
	if(parseFloat(gdata.SI[0].WithdrawAmount) > 0.00 ){
		...
		$('.Page9Withdrawal').html('# The projected Total Surrender Value is after the regular withdrawal of RM' + formatCurrency(gdata.SI[0].WithdrawAmount) + ' every ' + gdata.SI[0].WithdrawInterval +
					   ' year starting from policy year ' + gdata.SI[0].WithdrawAgeFrom + ' to policy year ' + gdata.SI[0].WithdrawAgeTo + '. ');
...
function writeRiderPage1()
{
	...
	var lengthToShow = gdata.SI[0].UL_Temp_Trad_Rider.p1[0].data.length > 32 ? 32 : gdata.SI[0].UL_Temp_Trad_Rider.p1[0].data.length;
		...
		$('.FirstPTypeRider').html('2nd Life Assured');
	    }
	    else if(gdata.SI[0].UL_Temp_Trad_Rider.p1[0].data[0].col0_1 == 'PAYOR' ){
		$('.FirstPTypeRider').html('Payor');
		
	    }
	    else{
		$('.FirstPTypeRider').html('1st Life Assured');
	    }
	}
...
function writeRiderPage2()
{
	...
	if(gdata.SI[0].UL_Temp_Trad_Rider.p2[0].data.length > 0){
		...
		$('.SecondPTypeRider').html('2nd Life Assured');
		}
		else if(gdata.SI[0].UL_Temp_Trad_Rider.p2[0].data[0].col0_1 == 'PAYOR' ){
		    $('.SecondPTypeRider').html('Payor');
		    
		}
		else{
		    $('.SecondPTypeRider').html('1st Life Assured');
		}
	}
}
...
if(gdata.SI[0].UL_Temp_Trad_Rider.p3[0].data.length > 0){
	...
	var lengthToShow = gdata.SI[0].UL_Temp_Trad_Rider.p3[0].data.length > 32 ? 32 : gdata.SI[0].UL_Temp_Trad_Rider.p3[0].data.length;
	for (var i = 2; i < parseInt(lengthToShow); i++) {//row data
	    row = gdata.SI[0].UL_Temp_Trad_Rider.p3[0].data[i];
...
if(gdata.SI[0].UL_Temp_Trad_Rider.p4[0].data.length > 0){
    ...
    for (var i = 2; i < gdata.SI[0].UL_Temp_Trad_Rider.p4[0].data.length; i++) {//row data
    	row = gdata.SI[0].UL_Temp_Trad_Rider.p4[0].data[i];
