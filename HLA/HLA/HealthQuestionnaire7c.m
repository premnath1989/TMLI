...
@interface HealthQuestionnaire7c ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire7c
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q7c"];
