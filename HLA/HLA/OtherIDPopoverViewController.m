...
@interface OtherIDPopoverViewController ()

@end

@implementation OtherIDPopoverViewController
...
{
	//if (indexPath.row == 0)
	NSString *selectedOtherIDType = [_IDTypes objectAtIndex:indexPath.row];
	NSLog(@"selected id :%@",selectedOtherIDType);

    
    //Notify the delegate if it exists.
    if (_delegate != nil) {
        [_delegate selectedOtherIDType:selectedOtherIDType];
