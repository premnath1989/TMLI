...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        NSDictionary *dict = [modelPopOver getReferralSource];
        _items = [dict objectForKey:@"ReferDesc"];
...
{
    NSString *theReferralDesc = [_items objectAtIndex:indexPath.row];
    SelectedString = theReferralDesc;
    [_delegate selectedReferralSource:theReferralDesc];
