...
@interface BasicAccountViewController : UIViewController<UITextFieldDelegate,PlanListDelegate, UIScrollViewDelegate>{
	...
	NSString *quotationLang;
	AppDelegate *appDel;
	BOOL Editable;
	NSMutableArray *RiderToBeDeleted;
}
...
@property (weak, nonatomic) IBOutlet UISegmentedControl *outletLanguage;
...
@property (nonatomic,strong) id requestOccCPA;
...
@property (nonatomic,assign, readwrite) double getGrayRTUP;
...
@property (nonatomic, assign,readwrite) BOOL LA_EDD;
