...
@interface HealthQuestionnaire8e ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire8e
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q8e"];
