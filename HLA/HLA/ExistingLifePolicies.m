...
- (void)selectedPersonType:(NSString *)thePersonType {
	...
	else if ([thePersonType isEqualToString:@"Payor"]) {
		NSLog(@"in po");
...
-(void) disableAll {
	...
	_addPolicyBtn.enabled = FALSE;
	//_viewPolicyBtn.hidden = FALSE;
	
	_Q1SC.enabled = FALSE;
	_noticeASC.enabled = FALSE;
	_noticeBSC.enabled = FALSE;
	_noticeCSC.enabled = FALSE;
	_noticeDSC.enabled = FALSE;

	
	_addPolicyPOBtn.hidden = FALSE;

	_noticeAPOSC.enabled = false;
	_noticeBPOSC.enabled = FALSE;
	_noticeCPOSC.enabled = FALSE;
	_noticeDPOSC.enabled = FALSE;
	_btnPolicyBdtPO.enabled = FALSE;
	_dateSpecialReqPOLbl.enabled = FALSE;
	_btnDateSpecialReqPO.enabled = FALSE;

	_Q1SC.enabled = FALSE;
	_addPolicyBtn.enabled = FALSE;
	_viewPolicyBtn.enabled = FALSE;
	_noticeASC.enabled = FALSE;
	_noticeBSC.enabled = FALSE;
	_noticeCSC.enabled = FALSE;
	_noticeDSC.enabled = FALSE;
	_btnPolicyBdt.enabled = FALSE;
	_dateSpecialReqLbl.enabled = FALSE;
