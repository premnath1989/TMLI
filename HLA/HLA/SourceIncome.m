...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        NSDictionary *dict = [modelPopOver getSourceIncome];
        _items = [dict objectForKey:@"SourceDesc"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [_delegate selectedSourceIncome:theSourceIncome];
