...
@interface HealthQuestionnaire7g ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire7g
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q7g"];
