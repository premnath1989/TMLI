...
@interface HealthQuestionnaire7j ()
{
    DataClass *obj;
}
@end

@implementation HealthQuestionnaire7j
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q7j"];
