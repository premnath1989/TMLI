...
@interface HealthQuestionnaire7f ()
...
@implementation HealthQuestionnaire7f
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q7f"];
