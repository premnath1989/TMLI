...
@interface HealthQuestionnaire7e ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire7e
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q7e"];
