...
- (IBAction)ActionBtn1:(id)sender {
	if ([LabelMsg isEqualToString:@""]) {
        ...
        else if([[LabelMsg substringToIndex:2 ] isEqualToString:@"Z2"] ){
            [_delegate ReturnSelection:@"Z2" andMsg:[LabelMsg substringFromIndex:2 ]  ];
		}
        else if([[LabelMsg substringToIndex:2 ] isEqualToString:@"R0"] ){
            [_delegate ReturnSelection:@"R0" andMsg:[LabelMsg substringFromIndex:2 ]  ];
		}
		else{
			[_delegate ReturnSelection:[MsgBtn1 substringToIndex:2 ] andMsg:[MsgBtn1 substringFromIndex:2 ]  ];
		}
