//
//  NationalityPopoverViewController.m
//  MPOS
//
...
@interface NationalityPopoverViewController ()

@end

@implementation NationalityPopoverViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        _IDTypes = [dict objectForKey:@"Nationality"];//[NSMutableArray array];
...
{
    NSString *selectedNationalityType = [_IDTypes objectAtIndex:indexPath.row];
	NSLog(@"selected id :%@",selectedNationalityType);
    
    
    //Notify the delegate if it exists.
    if (_delegate != nil) {
        [_delegate selectedNationality:selectedNationalityType];
    }
