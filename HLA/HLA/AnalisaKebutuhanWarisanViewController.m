//
//  AnalisaKebutuhanWarisanViewController.m
//  BLESS
//
...
@implementation AnalisaKebutuhanWarisanViewController
...
- (void)savetoDB:(NSDictionary *)params{
    ...
    [modifiedParams setObject:[[modelCFFHtml selectActiveHtmlForSection:@"WRS"] valueForKey:@"CFFHtmlID"] forKey:@"CFFHtmlID"];
    ...
    if ([arrayCFFAnswers count]>0){
        for (int i = 0;i<[arrayCFFAnswers count];i++){
            ...
            [tempDict setObject:[[modelCFFHtml selectActiveHtmlForSection:@"WRS"] valueForKey:@"CFFHtmlID"] forKey:@"CFFHtmlID"];
