...
- (void)viewDidLoad
{
    ...
    _wndLbl.textColor = [UIColor grayColor];
    _kwtcLbl.textColor = [UIColor grayColor];
...
- (IBAction)PrefferedLifeBTn:(id)sender {
}
