...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        NSDictionary *dict = [modelPopOver getVIPClass];
        _items = [dict objectForKey:@"VIPDesc"];
...
{
    NSString *theVIPDesc = [_items objectAtIndex:indexPath.row];
    SelectedString = theVIPDesc;
    [_delegate selectedVIPClass:theVIPDesc];
