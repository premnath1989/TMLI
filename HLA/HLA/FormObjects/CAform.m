...
{
    htmlContent = [[NSMutableString alloc]initWithString:[NSMutableString stringWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"index1" ofType:@"html" inDirectory:@"CA"]
...
//                                               baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"index1" ofType:@"html" inDirectory:[NSString stringWithFormat:@"CA"]]]
//                                            pathForPDF:[[NSString stringWithFormat:@"~/Documents/Forms/%@_CA.pdf",referenceNo] stringByExpandingTildeInPath]
//                                              delegate:nil
//                                              pageSize:kPaperSizeA4_portrait    //kPaperSizeA4_landscape for index4
//                                               margins:UIEdgeInsetsMake(10, 5, 10, 5)];
//    
    //HTTPPost *PostRequest = [[HTTPPost alloc]init];
    //[PostRequest HTTPPost:[NSString stringWithFormat:@"%@_CA.pdf",referenceNo]];
}
@end
