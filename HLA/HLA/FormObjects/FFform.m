...
{
    htmlContent = [[NSMutableString alloc]initWithString:[NSMutableString stringWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"index1" ofType:@"html" inDirectory:@"FF"]
...
//                                               baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"index1" ofType:@"html" inDirectory:[NSString stringWithFormat:@"FF"]]]
//                                            pathForPDF:[[NSString stringWithFormat:@"~/Documents/Forms/%@_FF.pdf",referenceNo] stringByExpandingTildeInPath]
//                                              delegate:nil
//                                              pageSize:kPaperSizeA4_portrait    //kPaperSizeA4_landscape for index4
//                                               margins:UIEdgeInsetsMake(11.2, 5, 10, 5)];
