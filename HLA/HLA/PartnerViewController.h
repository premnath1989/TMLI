...
@interface PartnerViewController : UITableViewController<UITextFieldDelegate,TitlePopoverViewControllerDelegate,OtherIDPopoverViewControllerDelegate, RacePopoverViewControllerDelegate, NationalityPopoverViewControllerDelegate, CountryPopoverViewControllerDelegate, CountryDelegate>
...
@property (nonatomic, copy) NSString *isEAPP;
