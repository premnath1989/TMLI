...
@implementation MainAddPolicyPOVC
...
- (void)viewDidLoad
{
	...
	AddPolicy = [self.storyboard instantiateViewControllerWithIdentifier:@"AddPolicyPO"];
	...
	num = 0;
	rrrnum = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"Count"] intValue];
//	test = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy"] objectForKey:@"S"] intValue];
	whichpolicy = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"WhichPolicy"]intValue];
	...
	if ([[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"PolicyData"] count] != 0) {
		_mutArray = [[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"PolicyData"];
	}
	
	if ([[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"WhichPolicy"] != Nil) {
...
- (void)viewDidDisappear:(BOOL)animated {
	...
	NSLog(@"how: %d", [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"PolicyData"] count]);
	if ([[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"PolicyData"] count] != 0) {
		[_delegate saveDataPO:_click];
	}
...
- (IBAction)actionForCancel:(id)sender {
	if ([[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] objectForKey:@"WhichPolicy"] == Nil) {
		[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] setValue:Nil forKey:@"PolicyData"]; }
	[self dismissViewControllerAnimated:YES completion:Nil];
}
...
- (void)saveExistingPolicy {
	...
	[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyPO"] setValue:_mutArray forKey:@"PolicyData"];
}
