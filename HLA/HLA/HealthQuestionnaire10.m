...
@interface HealthQuestionnaire10 ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire10
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q10"];
