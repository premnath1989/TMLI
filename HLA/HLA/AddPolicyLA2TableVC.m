...
@implementation AddPolicyLA2TableVC
...
- (void)viewDidLoad
{
	...
	pn = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyLA2"] objectForKey:@"WhichPolicy"]intValue];
	pc = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyLA2"] objectForKey:@"Count"] intValue];
	pcm = pc-1;
	_arrayPolicy = [[NSMutableArray alloc] init];
	if ([[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyLA2"] objectForKey:@"PolicyData"] count] != 0) {
		_arrayPolicy = [[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyLA2"] objectForKey:@"PolicyData"];
	}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (alertView.tag == 11 && buttonIndex == 0)
    {
		...
		[self dismissViewControllerAnimated:NO completion:^{
			NSLog(@"close");
			[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicyLA2"] setValue:_arrayPolicy  forKey:@"PolicyData"];
