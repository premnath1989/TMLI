...
@implementation MainAddPolicyLA2VC
...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
	AddPolicy = [self.storyboard instantiateViewControllerWithIdentifier:@"AddPolicyLA2"];
	...
	num = 0;
	rrrnum = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"Count"] intValue];
//	test = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"S"] intValue];
	whichpolicy = [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"WhichPolicy"]intValue];
	...
	if ([[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"PolicyData"] count] != 0) {
		_mutArray = [[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"PolicyData"];
	}
	
	if ([[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"WhichPolicy"] != Nil) {
...
- (IBAction)actionForDone:(id)sender {
	...
	if ([[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"WhichPolicy"] == Nil) {
		...
		if ([self checkAlert]) {
			...
			[[NSNotificationCenter defaultCenter]postNotificationName:@"TestNotificationLA2" object:self];}
...
- (void)viewDidDisappear:(BOOL)animated {
	...
	NSLog(@"how: %d", [[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"PolicyData"] count]);
	if ([[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"PolicyData"] count] != 0) {
		[_delegate saveDataLA2:_click];
	}
...
- (IBAction)actionForCancel:(id)sender {
	if ([[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] objectForKey:@"WhichPolicy"] == Nil) {
		[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] setValue:Nil forKey:@"PolicyData"]; }
	[self dismissViewControllerAnimated:YES completion:Nil];
}
...
- (BOOL)checkAlert {
	...
	else if ([AddPolicy.lifeTermTF.text intValue] <= 0 ){
	...
	else if ([AddPolicy.accidentTF.text intValue] <= 0 ){
	...
	else if ([AddPolicy.criticalIllnessTF.text intValue] <= 0 ){
...
- (void)saveExistingPolicy {
	...
	[[[obj.eAppData objectForKey:@"SecC"] objectForKey:@"ExistingPolicy2ndLA"] setValue:_mutArray forKey:@"PolicyData"];
}
