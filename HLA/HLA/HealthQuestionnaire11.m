...
@interface HealthQuestionnaire11 ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire11
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q11"];
