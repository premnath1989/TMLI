//
//  AnalisaKebutuhanInvestasiViewController.m
//  BLESS
//
...
@interface AnalisaKebutuhanInvestasiViewController (){
...
- (void)savetoDB:(NSDictionary *)params{
    ...
    [modifiedParams setObject:[[modelCFFHtml selectActiveHtmlForSection:@"INV"] valueForKey:@"CFFHtmlID"] forKey:@"CFFHtmlID"];
    ...
    if ([arrayCFFAnswers count]>0){
        for (int i = 0;i<[arrayCFFAnswers count];i++){
            ...
            [tempDict setObject:[[modelCFFHtml selectActiveHtmlForSection:@"INV"] valueForKey:@"CFFHtmlID"] forKey:@"CFFHtmlID"];
            ...
            [tempDict setObject:@"INV" forKey:@"CFFHtmlSection"];
...
- (NSMutableDictionary*)readfromDB:(NSMutableDictionary*) params{
    ...
    NSString* stringWhere = [NSString stringWithFormat:@"where CustomerID=%@ and CFFID=%@ and CFFTransactionID=%@ and CFFHtmlSection='INV'",prospectProfileID,[cffHeaderSelectedDictionary valueForKey:@"InvestasiCFFID"],[cffHeaderSelectedDictionary valueForKey:@"CFFTransactionID"]];
