...
@interface EverLifeViewController : UIViewController<NDHTMLtoPDFDelegate>{
	NSString *databasePath, *RatesDatabasePath, *UL_RatesDatabasePath;
    sqlite3 *contactDB;
	
	NSString *CustCode;
	NSString *CustCode2nd;
	NSString *CustCodePayor;
	NSString *OccpCode;
	NSString *OccpCode2nd;
	NSString *OccpCodePayor;
	NSString *getOccLoading;
	NSString *getCommDate;
	NSString *getDOB2nd;
	NSString *getSex2nd;
	NSString *getSmoker2nd;
	NSString *getOccpClass2nd;
	NSString *getDOBPayor;
	NSString *getSexPayor;
	NSString *getSmokerPayor;
	NSString *getOccpClassPayor;
    NSMutableArray *OtherRiderPaymentChoice;
    NSMutableArray *OtherRiderLoadingPremium;
	NSMutableArray *OtherRiderPTypeCode;
    NSMutableArray *OtherRiderPTypeSeq;
    NSMutableArray *UnitizeRiderHLTerm;
    NSMutableArray *UnitizeRiderHLPctTerm;
    NSMutableArray *OtherRiderOverallTPDEOY;
    NSMutableArray *UnitizeRiderPremium2;
    NSMutableArray *UnitizeRiderPremium3;
    NSMutableArray *UnitizeRiderPreDeductible;
    NSMutableArray *UnitizeRiderPostDeductible;
    NSMutableArray *UnitizeRiderUnits;
}
...
@property (nonatomic,strong) id getPlanCode;
...
@property (nonatomic,assign) BOOL IsEDD;
...
@property (retain, nonatomic) NSMutableArray *BullSurrender;
@property (retain, nonatomic) NSMutableArray *FlatSurrender;
@property (retain, nonatomic) NSMutableArray *BearSurrender;
...
-(double)FromBasic :(NSString *)aaATPrem andGetHL :(NSString *)aaGetHL andGetHLPct :(NSString *)aaGetHLPct 
		...
		andLAAge:(int)aaLAAge andGrayRTUO :(double)aaGrayRTUO andPlanCode :(NSString *)aaPlanCode ;
