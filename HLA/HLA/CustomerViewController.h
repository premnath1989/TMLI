...
@interface CustomerViewController : UITableViewController<UITextFieldDelegate,TitlePopoverViewControllerDelegate,OtherIDPopoverViewControllerDelegate, RacePopoverViewControllerDelegate, NationalityPopoverViewControllerDelegate, CountryPopoverViewControllerDelegate, CountryDelegate>
...
@property (weak, nonatomic) IBOutlet UIButton *ForeignPermanentButton;
...
@property bool foreignAddress;
@property bool permanentForeignAddress;

- (IBAction)postChanged:(id)sender;
- (IBAction)PermanentpostcodeChanged:(id)sender;
