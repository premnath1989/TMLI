...
@interface HealthQuestionnaire12 ()
{
    DataClass *obj;
}
...
@implementation HealthQuestionnaire12
...
- (void)viewDidLoad
{
    ...
    NSString* text = [[obj.eAppData objectForKey:@"SecE"] objectForKey:@"Q12"];
