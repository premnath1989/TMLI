...
function loadFooter()
{
    var str = "<div><table border='0' style='border-collapse:separate;border:0px solid black;width:100%;'><tr><td width='75%' style='font-family:Times New Roman;font-size:9.5px;font-weight:normal;padding: 5px 5px 5px 0px;'>This Product Disclosure Sheet consists of <span class='totalPages'>{totalPages}</span> pages and each page forms an integral part of the Product Disclosure Sheet. A prospective policy owner is advised to read and<br/>understand the information printed on each and every page.<br/><b><span id='rptVersion' class='rptVersion'>{rptVersion}</span></b> <br/>Level 3, Tower B, PJ City Development, No. 15A Jalan 219, Seksyen 51A, 46100 Petaling Jaya, Selangor. Tel: 03-7650 1818 Fax: 03-7650 1991 Website: www.hla.com.my<br/></td><td width='10%' align='left' valign='bottom' style='padding: 0px 0px 0px 0px;font-family:Times New Roman;font-size:10px;font-weight:normal;'>Page <span class='currentPage'>22</span> of <span class='totalPages'>56</span></td><td width='15%' align='right' valign='bottom' style='padding: 0px 0px 0px 0px;font-family:Times New Roman;font-size:12px;font-weight:normal;'>Ref: <span id=SICode class='SICode'>{SINo}</span></td></tr></table></div>";
...
function createPage(pageNo)//append each page to the main page
{
    ...
    td2.innerHTML ="<table border ='0' style=' font-family:Times New Roman;font-size:12px;font-weight:normal'><tr><td colspan='3'><span>This product disclosure sheet consists of<span>7</span>pages and each page forms an integral part of the sales illustration. A prospective policy owner is advised to read and understand the information printed on each and every page.</br><b>Win MP (Ever & EverLove Plus Series) Version 3.8 (Agency) Last Updated 30 May 2013 - E&OE-</b></span></td></tr><tr><td style='width: 60%'>Level 3, Tower B, PJ City Development, No. 15A Jalan 219, Seksyen 51A, 46100 Petaling Jaya, Selangor. Tel: 03-7650 1818 Fax: 03-7650 1991 Website: www.hla.com.my</td><td style='width: 10%' >page <span id='currPageID'>{currPageNo}</span> of <span class='totalPageNoClass'>{Pages}</span></td><td style='width: 10%;text-align: right'>ref: 12345678910-1234</td></tr></table>";
