...
@interface TitlePopoverViewController ()

@end

@implementation TitlePopoverViewController
...
{
	//if (indexPath.row == 0)
	NSString *selectedTitleType = [_IDTypes objectAtIndex:indexPath.row];
	//NSLog(@"selected id :%@",selectedTitleType);

    
    //Notify the delegate if it exists.
    if (_delegate != nil) {
        [_delegate selectedTitleType:selectedTitleType];
