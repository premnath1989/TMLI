//
//  CountryPopoverViewController.m
//  iMobile Planner
//
...
@interface CountryPopoverViewController ()

@end

@implementation CountryPopoverViewController
...
{
    NSString *selectedCountryType = [_IDTypes objectAtIndex:indexPath.row];
	NSLog(@"selected id :%@",selectedCountryType);
    
    
    //Notify the delegate if it exists.
    if (_delegate != nil) {
        [_delegate selectedCountry:selectedCountryType];
    }
