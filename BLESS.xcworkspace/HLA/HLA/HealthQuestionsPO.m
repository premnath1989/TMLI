...
- (IBAction)isAllNo:(id)sender
{
    ...
    if (checked) {
        ...
        _segQ1B.selectedSegmentIndex = 1;
        _segQ2.selectedSegmentIndex = 1;
        _segQ3.selectedSegmentIndex = 1;
        _segQ4.selectedSegmentIndex = 1;
        _segQ5.selectedSegmentIndex = 1;
        _segQ6.selectedSegmentIndex = 1;
        _segQ7A.selectedSegmentIndex = 1;
        _segQ7B.selectedSegmentIndex = 1;
        _segQ7C.selectedSegmentIndex = 1;
        _segQ7D.selectedSegmentIndex = 1;
        _segQ7E.selectedSegmentIndex = 1;
        _segQ7F.selectedSegmentIndex = 1;
        _segQ7G.selectedSegmentIndex = 1;
        _segQ7H.selectedSegmentIndex = 1;
        _segQ7I.selectedSegmentIndex = 1;
        _segQ7J.selectedSegmentIndex = 1;
        _segQ8A.selectedSegmentIndex = 1;
        _segQ8B.selectedSegmentIndex = 1;
        _segQ8C.selectedSegmentIndex = 1;
        _segQ8D.selectedSegmentIndex = 1;
        _segQ8E.selectedSegmentIndex = 1;
        _segQ9.selectedSegmentIndex = 1;
        _segQ10.selectedSegmentIndex = 1;
        _segQ11.selectedSegmentIndex = 1;
        _segQ12.selectedSegmentIndex = 1;
        _segQ13.selectedSegmentIndex = 1;
	...
	switch ([sender tag]) {
		...
		case 142:
			if ([sender selectedSegmentIndex] == 0) {
				...
				_yes14b.hidden = NO;[[[obj.eAppData objectForKey:@"SecE"] objectForKey:@"POHQ"] setValue:@"Y" forKey:@"SecE_Q14B"];
			}
			else {
				_yes14b.hidden = YES;
                Q142 = [self.storyboard instantiateViewControllerWithIdentifier:@"MainQViewController"];
