...
@interface eAppsListing : UIViewController <UITableViewDataSource,UITableViewDelegate, UITextFieldDelegate, UIPopoverControllerDelegate, EditProspectDelegate, UIAlertViewDelegate, CustomAlertBoxDelegate> {
