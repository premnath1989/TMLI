...
function Page3_UV()
{
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2025 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0"){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">26/11/2023 sehingga 25/11/2025</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2023  + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2025 + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2028 + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2030 + '</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2028 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" ){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">26/11/2025 sehingga 25/11/2028</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2028 + '</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">' + gdata.SI[0].UL_Page3.data[0].VU2030 + '</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2030 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" && gdata.SI[0].UL_Page3.data[0].VU2028 == "0" ){
			...
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">26/11/2028 sehingga 25/11/2030</td>' +
	...
	if( gdata.SI[0].UL_Page3.data[0].VU2035 != "0"){
		if(gdata.SI[0].UL_Page3.data[0].VU2023 == "0" && gdata.SI[0].UL_Page3.data[0].VU2025 == "0" && gdata.SI[0].UL_Page3.data[0].VU2028 == "0" && gdata.SI[0].UL_Page3.data[0].VU2030 == "0" ){
			$('#TablePage3_1 > tbody').append('<tr>' +
			'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">26/11/2030 sehingga 25/11/2035</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
			'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
	...
	if(gdata.SI[0].UL_Page3.data[0].VUCashOpt != '0'){
		$('#TablePage3_1 > tbody').append('<tr>' +
		'<td style="text-align:left;padding: 2px 2px 2px 2px;border: 1px solid black;">26/11/2035 sehingga Tarikh Kematangan Polisi</td>' +
		'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
		'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
		'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
		'<td style="text-align:center;padding: 2px 2px 2px 2px;border: 1px solid black;">0.00</td>' +
	...
	$.each(gdata.SI[0].UL_Temp_trad_Details.data, function(index, row) {
		...
		if(row.RiderCode != 'ECAR' && row.RiderCode != 'ECAR55' && row.RiderCode != 'ECAR6'  ){
			...
			if(row.PTypeCode == 'LA' && row.Seq == '1'){
				temp = ('(Hayat Diinsuranskan Pertama)');
			}
...
function Page44_UV(){
	...
	if(tempECAR55Exist == true){
		$('.Page44-ECAR55').html( '<b>Penalti Cukai untuk Penyerahan Penuh Awal</b><br/>' +
				'Sejajar dengan objektif persaraan bagi produk Annuiti Tertangguh, anda akan dikenakan penalti cukai atas penyerahan rider ini sebelum umur persaraan minimum di samping caj penyerahan yang dikenakan. Untuk mengillustrasikan,' +
				'8% penalti cukai yang ditolak daripada nilai penyerahan anda adalah seperti berikut:<br/>' +
				'Dengan anggapan bahawa EverCash 55 Rider anda telah memperoleh nilai penyerahan sebanyak RM40,000, di mana anda telah menuntut pelepasan cukai sebanyak RM3,000 selama 10 tahun (iaitu anda telah menuntut pelepasan cukai' +
				'sebanyak RM30,000 secara keseluruhan). Selepas penolakan penalti cukai sebanyak 8% atas jumlah pelepasan cukai yang dituntut (iaitu RM30,000 X 8/100 = RM2,400, yang dibayar kepada pihak berkuasa percukaian), anda hanya akan menerima RM37,600 (iaitu RM40,000 - RM2,400) sebagai nilai penyerahan anda.')		
	}
	else{
		$('.Page44-ECAR55').html( '&nbsp;');
	}
...
function Page50_UV()
{
	...
	if(gdata.SI[0].UL_Temp_trad_Details.data.length > 0){
		...
		{
			//arr.splice(arr.indexOf(temp2), 1);	
		}
